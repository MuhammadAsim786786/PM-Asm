...
export default function Page() {
  ...
  return (
    <div className="min-h-screen px-3 sm:px-4 md:px-6 py-6 sm:py-8 md:py-10 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex justify-center">
      <div className="w-full max-w-6xl">
        <header className="mb-6 sm:mb-8 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
            Standards Comparison
          </h1>
          <p className="text-sm sm:text-base text-slate-600 mt-2 px-2 max-w-2xl mx-auto">
                      ...
                      >
                        ...
                        {expanded && (
                          s.matches && s.matches.length > 0 ? (
                            <div className="mt-2 sm:mt-3 p-2 sm:p-3 bg-slate-50 rounded text-xs sm:text-sm text-slate-700 border-l-2 border-blue-400">
                            ...
                            <div className="mt-2 sm:mt-3 p-2 sm:p-3 bg-amber-50 rounded text-xs text-slate-600 border-l-2 border-amber-400">
                              <span className="font-medium">Note:</span> This summary was generated by analyzing the entire document and extracting key concepts related to <strong>{query}</strong>, even though no exact section match was found.
                            </div>
                          )
                        )}
                      </article>
